...
emmo = get_ontology('mechanical-testing.owl')
emmo.load()
#emmo.sync_reasoner()
...
def emmodoc(filename='emmodoc.html', format=None, figformat=None,
    ...
    with open(os.path.join(thisdir, 'mec-intro.md'), 'r') as f:
        doc.append(f.read() + '\n\n')
    ...
    metafile = os.path.join(thisdir, 'mec-meta.yaml')
...
if __name__ == '__main__':
    ...
    emmodoc('mec.html', figscale=1.2, tmpdir=tmpdir)
    emmodoc('mec.pdf', figscale=0.7, tmpdir=tmpdir)
